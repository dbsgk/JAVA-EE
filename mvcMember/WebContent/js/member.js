...
function idCheck(){
	...
	if(sId=="") 
		...
		window.open("/mvcMember/member/checkId.do?id="+sId, "", "width=500 height=180 left=800 top=100");
}
...
function checkPost() {
	window.open("/mvcMember/member/checkPost.do", "", "width=550 height=400 scrollbars=yes")
}
