...
//데이터
String subject = multi.getParameter("subject");// request.getParameter를 이제 multi.getParameter로 사용(모든 권한이 이관되어서)
...
File file1 = multi.getFile("upload1"); //파일위치(input name="upload1")
...
<ul>
	...
	<li>파 일 : <a href="fileDownload.jsp?fileName=<%=URLEncoder.encode(originalFileName1,"UTF-8") %>"><%=originalFileName1 %></a><br><!-- ?변수명=값 -->
	<li>파 일 : <%=fileName1 %><br> 
	<li>크 기 : <%=fileSize1 %><br>
	-----------------------------------
	<li>파 일 : <a href="fileDownload.jsp?fileName=<%=URLEncoder.encode(originalFileName2,"UTF-8") %>"><%=originalFileName2 %></a>
	<li>파 일 : <%=fileName2 %><br>
	<li>크 기 : <%=fileSize2%><br>
</ul>
</body>
