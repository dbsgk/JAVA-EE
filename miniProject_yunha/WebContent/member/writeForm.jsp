...
<table id="table-writeForm" >
	<tr>
		...
		<td><input type="text" name="write_name" id="write_name" placeholder="이름 입력" class="t1"><div id="div-name"></div></td>
	</tr>
	<tr>
		<td class="fieldName">아이디</td>
		<td><input type="text" name="write_id" id="write_id" placeholder="아이디 입력" class="t1">
			<input type="button" value="중복체크" class="" onclick="idCheck()" style="padding:2px;"><div id="div-id"></div></td>
	</tr>
	<tr>
		<td class="fieldName">비밀번호</td>
		<td><input type="password" name="write_pwd" id="write_pwd" placeholder="비밀번호 입력" class="t1"><div id="div-pass"></div></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			...
			<input type="text" name="addr1" id="addr1" class="addr" placeholder="주소" readonly><br>
	...
	<tr>
		<td colspan="2" style="text-align:center;">
			...
			<input type="button" value="회원가입" class="btn" id="writeFormBtn" name="writeFormBtn">
			<input type="reset" value="다시작성" class="btn">
			<input type="button" value="로그인 페이지" class="btn" onclick="location.href='/member/loginForm.do'">
		</td>
	</tr>
